 ...
 * Description:       The plugin will show products as slider or carousel.
 * Version:           2.3.0
 * Author:            PLUGINIC
...
define( 'GPSC_PLUG_VERSION', $wpgpscyg_plugin_data['version'] );
define( 'GPSC_PLUG_BASE_FILE', plugin_basename( __FILE__ ) );
define( 'GPSC_PLUG_DIR_PATH_FILE', plugin_dir_path( __FILE__ ) );
define( 'GPSC_PLUG_DIR_URL_FILE', plugin_dir_url( __FILE__ ) );
...
function activate_gpsc_product_slider_carousel() {
	 ...
	 */
	set_transient( '_gpsc_safe_redirect', true, 60 );
...
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgpsc-framework/metabox/appearance.php';
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgpsc-framework/metabox/controls.php';
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgpsc-framework/metabox/colors.php';
...
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgpsc-framework/metabox/product-single.php';
// Settings.
...
require_once plugin_dir_path( __FILE__ ) . 'admin/wpgpsc-framework/option/settings-single-page.php';
