 ...
 *
 */
if ( ! class_exists( 'WPGPSC_Field_textarea' ) ) {
  class WPGPSC_Field_textarea extends WPGPSC_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        $instances  = ( ! empty( WPGPSC::$shortcode_instances ) ) ? WPGPSC::$shortcode_instances : array();
          ...
          foreach ( $shortcodes as $shortcode ) {
            ...
            foreach ( $instances as $instance ) {
              ...
              if ( $instance['modal_id'] === $shortcode ) {
                ...
                echo '<a href="#" class="button button-primary wpgpsc-shortcode-button" data-modal-id="'. esc_attr( $id ) .'">'. esc_html( $title ) .'</a>';
