 ...
 *
 */
if ( ! class_exists( 'WPGPSC_Field_sortable' ) ) {
  class WPGPSC_Field_sortable extends WPGPSC_Fields {
    ...
    public function render() {
      ...
      echo '<div class="wpgpsc-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="wpgpsc-sortable-item">';

          echo '<div class="wpgpsc-sortable-content">';
          ...
          WPGPSC::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="wpgpsc-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
