	...
	array(
		...
		'fields' => array(
			...
			array(
				'type'    => 'notice',
				'style'   => 'warning',
				'content' => '<strong>Note:</strong> If you\'re seeking greater versatility and more robust options for the \'Add to Cart\' button, <a href="https://wordpress.org/plugins/add-to-cart-button-for-woocommerce/" target="_blank">consider using this plugin</a>.',
			),
			array(
				'id'         => 'gpsc_atc_btn_change',
				'type'       => 'switcher',
				'title'      => 'Want to Change "Add to Cart" Button Text?',
				'text_on'    => 'Yes',
				'text_off'   => 'No',
				'text_width' => 60,
				'default'    => false,
