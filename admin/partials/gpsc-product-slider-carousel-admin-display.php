...
.confetti-piece:nth-child(2) {
	...
	-webkit-animation-duration: 856ms;
...
.confetti-piece:nth-child(5) {
	...
	-webkit-animation-duration: 801ms;
...
.confetti-piece:nth-child(10) {
	...
	-webkit-animation-duration: 984ms;
...
.confetti-piece:nth-child(11) {
	...
	-webkit-animation-duration: 959ms;
	animation-duration: 959ms;
}
...
.woo-psc-testimonial-stars > img {
	width: 120px;
	height: auto;
	filter: drop-shadow(0px 0px 1px #7c7c7c);
    margin-bottom: 5px;
}
...
<div class="woo-psc-option-body">
	<div class="woo-psc-setting-header">
		<div class="woo-psc-setting-header-info">
			<img src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/icon-128x128.png' ); ?>" alt="Product Slider Carousel">
			<div class="woo-psc-plugin-about">
				<h1>Product Slider Carousel<sup id="woo-psc-plugin-version"><?php echo esc_html( GPSC_PLUG_VERSION ); ?></sup></h1>
	...
	<div class="woo-psc-container-wrap">
			...
			<div class="woo-psc-container-hero">
				...
				<div class="woo-psc-container-ad">
					<a href="https://pluginic.com/services/?ref=100" target="_blank">
						<picture>
							<source media="(max-width:960px)" srcset="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/banner-960x340.jpg' ); ?>">
							<img src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/banner-340x520.jpg' ); ?>">
						</picture>
					</a>
				</div>
			</div>
		...
		<div class="woo-psc-hero-upgrade">
			...
			<a href="https://pluginic.com/plugins/" target="_blank">Get some more solutions →</a>
		</div>
		<div class="woo-psc-spacer" style="height: 20px;"></div>
			...
			<div class="woo-psc-testimonial-columns">
				<div class="woo-psc-testimonial-column">
					<span class="woo-psc-testimonial-stars">
						<img src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/5-star-rating.svg' ); ?>">
					</span>
					...
					<div class="woo-psc-testimonial-client">
						<img width="50" height="50" src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/client-1.png' ); ?>" alt="" class="wp-image-3273">
				...
				<div class="woo-psc-testimonial-column">
					...
					<p style="font-size:18px;line-height:1.3;margin-bottom:15px">“Suitable for all types of websites, large or small. Easy to set up and lots of documentation to help me.</p>
					<div class="woo-psc-testimonial-client">
						<img width="50" height="50" src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/client-2.png' ); ?>" alt="" class="wp-image-3273">
						<div class="woo-psc-testimonial-client-ghost">
							<h4>Bert Mora</h4>
							<p>UI Developer</p>
						</div>
				...
				<div class="woo-psc-testimonial-column">
					...
					<div class="woo-psc-testimonial-client">
						<img width="50" height="50" src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/client-3.png' ); ?>" alt="" class="wp-image-3273">
						<div class="woo-psc-testimonial-client-ghost">
							<h4>Carol Stokes</h4>
							<p>IT Specialist</p>
						</div>
				...
				<div class="woo-psc-testimonial-column">
					...
					<div class="woo-psc-testimonial-client">
						<img width="50" height="50" src="<?php echo esc_url( GPSC_PLUG_DIR_URL_FILE . 'admin/img/client-4.png' ); ?>" alt="" class="wp-image-3273">
						<div class="woo-psc-testimonial-client-ghost">
							<h4>Roman Rybakov</h4>
